                    ...
                    <div class="center">
                        ...
                        <form onclick="return false;">
                            <fieldset class="form-group">
                                ...
                                <textarea class="form-control" id="text-for-handle" rows="10" placeholder="Enter text"></textarea>
                            </fieldset>
                            <div class="custom-center">
                                <button id="handle-text" type="submit" class="btn btn-primary">
                                    <spring:message code="label.process.text"/>
                                </button>
                            </div>
                        </form>  
            ...
            <div class="row">
                <div class="span12">
                    <div class="page-header" align="center">
                        <h2><spring:message code="label.processed.text"/></h2>
                    </div>
                    <div class="table">
                ...
                <div class="modal-content">
                    <div class="modal-header modal-header-custom">
                        ...
                        <h4 class="modal-title" id="myModalLabel">
                            <spring:message code="label.text.statistics.table.name"/>
                        </h4>
                    </div>
